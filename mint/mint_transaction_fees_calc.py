        ...
        for rece in block_receipts:
            ...
            if str(from_addr) == "0xdeaddeaddeaddeaddeaddeaddeaddeaddead0001":
                ...
                if hex_gas_used and hex_gas_price:
                    ...
                    tx_l2_fee = gas_used * gas_price
                    block_l2_fee += tx_l2_fee
                if hex_l1_fee:
                    l1_fee = int(hex_l1_fee, base=16)
                    block_l1_fee += l1_fee

        total_l2_fee += block_l2_fee
        total_l1_fee += block_l1_fee
        
        print(f"block: {start_block_number}, block_l2_fee: {block_l2_fee}, total_l2_fee: {total_l2_fee}")
...
if __name__ == "__main__":
    total_l2_fee = main()
    print("total l2 fee:", total_l2_fee)
